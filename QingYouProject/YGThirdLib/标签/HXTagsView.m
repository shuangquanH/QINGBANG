...
-(void)setLayout:(HXTagCollectionViewFlowLayout *)layout{
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //return CGSizeMake(frame.size.width + _tagAttribute.tagSpace, layout.itemSize.height / 2 + 5);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.delegateImageView.hidden = self.isShowDelegate ? NO : YES;
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        ...
        cell.layer.borderColor = _tagAttribute.selectedBorderColor.CGColor;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        ...
        if (_isMultiSelect) {//允许多选
            cell.titleLabel.textColor = _tagAttribute.normalTextColor;
            cell.backgroundColor = _tagAttribute.normalBackgroundColor;
            
            [self.selectedTags removeObject:self.tags[indexPath.item]];
            [self.selectedIndexs removeObject:@(indexPath.item)];
        ...
        if (_isMultiSelect) {
            ...
            [self.selectedIndexs addObject:@(indexPath.item)];
    ...
    if (_completion) {
        _completion(self.selectedTags,self.selectedIndexs,indexPath.item);
