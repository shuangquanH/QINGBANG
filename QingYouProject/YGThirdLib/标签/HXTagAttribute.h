...
@property (nonatomic,assign) BOOL isCircle;//是否圆边
...
@property (nonatomic,strong) UIColor *normalTextColor;//标签字体颜色
@property (nonatomic,strong) UIColor *selectedTextColor;//标签字体颜色
