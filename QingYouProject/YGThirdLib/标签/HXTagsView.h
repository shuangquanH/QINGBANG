...
@property (nonatomic,strong) NSMutableArray *tags;//传入的标签数组 字符串数组
@property (nonatomic,strong) HXTagCollectionViewFlowLayout *layout;//布局layout
/** 是否显示删除视图  */
@property (nonatomic,assign) BOOL isShowDelegate;
...
@property (nonatomic,copy) void (^completion)(NSArray *selectTags,NSArray *selectIndexs,NSInteger currentIndex);//选中的标签数组,当前点击的index
