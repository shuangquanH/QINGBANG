...
+ (NSMutableArray *)indexArrayFromStringArray:(NSArray *)stringArr
{
...
+ (NSMutableArray *)letterSortArrayFromStringArray:(NSArray *)stringArr
{
    NSMutableArray *tempArray = [self ReturnSortChineseArrar:stringArr];
...
+ (NSMutableArray *)indexFromListArray:(NSArray *)objectArray key:(NSString *)key
{
...
//给对象数组排序
+ (NSMutableArray *)sortFromListArray:(NSArray *)objectArray key:(NSString *)key
{
    //计算函数耗时
