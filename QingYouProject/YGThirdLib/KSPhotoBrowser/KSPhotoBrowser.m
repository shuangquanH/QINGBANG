...
- (void)dealloc {
    [[NSNotificationCenter defaultCenter]removeObserver:self name:@"KSPhotoBrowserScroll" object:nil];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"KSPhotoBrowserScroll" object:nil userInfo:@{@"index":[ NSString stringWithFormat:@"%ld",_currentPage]}];
}
