...
//    _skLabel.borderColor = colorWithMainColor;
    _skLabel.textColor = colorWithMainColor;
...
- (void)setModel:(GiftModel *)model {
    _model = model;
    [_headImageView sd_setImageWithURL:[NSURL URLWithString:model.headImageUrl] placeholderImage:YGDefaultImgAvatar];
    [_giftImageView sd_setImageWithURL:[NSURL URLWithString:model.giftImageUrl] placeholderImage:YGDefaultImgAvatar];
