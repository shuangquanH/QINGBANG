...
{
    NSData *plainTextData = [content dataUsingEncoding:NSUTF8StringEncoding];
    NSData *cipherTextData = [plainTextData AES256EncryptWithKey:[NSData getYoGeeKey]];
    NSString *string = [[[[NSString stringWithFormat:@"%@",cipherTextData]
...
{
    NSData *plainTextData = [NSJSONSerialization dataWithJSONObject:dic options:0 error:nil];
    NSData *cipherTextData = [plainTextData AES256EncryptWithKey:[NSData getYoGeeKey]];
    NSString *string = [[[[NSString stringWithFormat:@"%@",cipherTextData]
                          stringByReplacingOccurrencesOfString: @"<" withString: @""]
                         stringByReplacingOccurrencesOfString: @">" withString: @""]
...
+ (NSData *)getYoGeeKey
{
    ...
    Byte keyByte[] = { 0x08, 0x08, 0x04, 0x0b, 0x02, 0x0f, 0x0b, 0x0c,
        0x01, 0x03, 0x08, 0x07, 0x0c, 0x03, 0x08, 0x0a, 0x04, 0x0f,
        0x06, 0x0f, 0x0e, 0x09, 0x08, 0x01, 0x0a, 0x0a, 0x01, 0x09,
        0x06, 0x07, 0x09, 0x0d };
