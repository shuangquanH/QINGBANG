...
@interface AboutRecommendController ()<WKNavigationDelegate,WKUIDelegate>
@property(nonatomic,strong)WKWebView *webView;
@property(nonatomic,strong)WKWebViewConfiguration *wkWebConfig;

@end

@implementation AboutRecommendController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.naviTitle = @"关于青友推荐";
...
-(void)loadData
{
    [YGNetService YGPOST:@"getQingyouRecommend" parameters:@{} showLoadingView:NO scrollView:nil success:^(id responseObject) {
        
        NSLog(@"%@",responseObject);
    
        NSString *htmlString = [responseObject valueForKey:@"text"];
