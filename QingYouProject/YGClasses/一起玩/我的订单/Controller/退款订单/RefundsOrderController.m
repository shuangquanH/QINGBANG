...
@interface RefundsOrderController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation RefundsOrderController
{
...
{
    [YGNetService YGPOST:REQUEST_ActivityOrderList parameters:@{@"userID":YGSingletonMarco.user.userId,@"type":@"4",@"total":self.totalString,@"count":self.countString} showLoadingView:NO scrollView:_tableView success:^(id responseObject) {
        if (headerAction == YES) {
