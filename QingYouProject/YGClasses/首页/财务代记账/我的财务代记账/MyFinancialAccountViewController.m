//
//  MyFinancialAccountViewController.m
//  QingYouProject
//
...
@interface MyFinancialAccountViewController ()<YGSegmentViewDelegate,UIScrollViewDelegate>
{
...
@implementation MyFinancialAccountViewController
...
- (void)configUI
{
    ...
    _controllersArray = [[NSMutableArray alloc]initWithArray:@[@"MyFinancialAccountWaitToDealViewController",@"MyFinancialAccountDealingViewController",@"MyFinancialAccountDealedViewController"]];
