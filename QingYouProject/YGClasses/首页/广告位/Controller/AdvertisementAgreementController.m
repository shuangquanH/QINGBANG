//
//  AdvertisementAgreementController.m
//  QingYouProject
//
...
@interface AdvertisementAgreementController ()<WKNavigationDelegate,WKUIDelegate>
@property(nonatomic,strong)WKWebView *webView;
@property(nonatomic,strong)WKWebViewConfiguration *wkWebConfig;

@end

@implementation AdvertisementAgreementController
...
-(void)loadData
{
    [YGNetService YGPOST:@"AdsAgreement" parameters:@{} showLoadingView:NO scrollView:nil success:^(id responseObject) {
