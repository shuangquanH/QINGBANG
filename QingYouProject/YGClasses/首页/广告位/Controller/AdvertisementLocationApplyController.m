//
//  AdvertisementLocationApplyController.m
//  QingYouProject
//
...
@interface AdvertisementLocationApplyController () <UIScrollViewDelegate,YGSegmentViewDelegate>
...
- (void)addChildViewControllers{
    for (int i = 0; i < self.childArray.count; i++) {
        ...
        AlreadyProcessedViewController * vc = [[className alloc] init];
        vc.pageType = i;
        vc.typeString = [NSString stringWithFormat:@"%d",i+1];
