//
//  SecondPayNotesViewController.m
//  QingYouProject
//
...
@interface SecondPayNotesViewController ()<WKNavigationDelegate,WKUIDelegate>
...
@implementation SecondPayNotesViewController
...
-(void)loadData
{
    [YGNetService YGPOST:@"getPayNotes" parameters:@{} showLoadingView:NO scrollView:nil success:^(id responseObject) {
