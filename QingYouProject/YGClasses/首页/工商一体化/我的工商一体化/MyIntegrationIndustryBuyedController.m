//
//  MyIntegrationIndustryBuyedController.m
//  QingYouProject
//
...
#import "MyIntegrationIndustryBuyedController.h"
...
@interface MyIntegrationIndustryBuyedController ()<UITableViewDelegate,UITableViewDataSource,FinancialAccountReturnMoneyViewControllerDelegate>
@property (nonatomic,strong) UITableView * tableView;
/** 数据源  */
@property (nonatomic,strong) NSMutableArray * dataArray;
@end

@implementation MyIntegrationIndustryBuyedController
...
-(void)delButtonClick:(UIButton *)btn
{
    ...
    financiaAccount.integrationModel = self.dataArray[row];
    financiaAccount.delegate =self;
    financiaAccount.row =row;
