...
{
    self.naviTitle = @"我的投诉";
    self.navigationItem.rightBarButtonItem = [self createBarbuttonWithNormalImageName:@"decorate_nav_icon" selectedImageName:nil selector:@selector(rightBarButtonClick:)];
