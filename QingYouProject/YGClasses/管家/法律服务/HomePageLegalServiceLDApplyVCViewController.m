//
//  HomePageLegalServiceLDApplyVCViewController.m
//  QingYouProject
//
...
#import "HomePageLegalServiceLDApplyVCViewController.h"
#import "LDTextView.h"
#import <WebKit/WebKit.h>
#import "AreaSelectViewController.h"
@interface HomePageLegalServiceLDApplyVCViewController ()<WKNavigationDelegate>
/** 背景ScrollowView  */
...
@implementation HomePageLegalServiceLDApplyVCViewController
...
- (void)viewDidLoad {
    ...
    //网络请求
    [self sendRequest];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(HomePageLegalService:) name:@"HomePageLegalService" object:nil];
    
}
- (void)HomePageLegalService:(NSNotification *)notifit {
...
- (void)sendRequest{
    ...
    [YGNetService YGPOST:@"LawServiceIntroduce" parameters:@{@"serviceID":self.serviceID} showLoadingView:YES scrollView:nil success:^(id responseObject) {
...
- (void)bottomButtonClick:(UIButton *)bottomButton{
    ...
    [YGNetService YGPOST:@"LawCreateOrder" parameters:parameters showLoadingView:YES scrollView:nil success:^(id responseObject) {
