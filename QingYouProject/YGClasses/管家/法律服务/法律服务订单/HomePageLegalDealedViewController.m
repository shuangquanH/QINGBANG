//
//  HomePageLegalDealedViewController.m
//  QingYouProject
//
...
#import "HomePageLegalDealedViewController.h"
#import "WaitToNetManagerTableViewCell.h"
#import "WaitToNetManagerModel.h"
#import "HomePageLegalJudgeViewController.h"

@interface HomePageLegalDealedViewController ()<UITableViewDelegate,UITableViewDataSource,HomePageLegalJudgeViewControllerDelegate>
...
@implementation HomePageLegalDealedViewController
...
-(void)judgeButtonClick:(UIButton *)btn
{
    ...
    HomePageLegalJudgeViewController * judgeView =[[HomePageLegalJudgeViewController alloc]init];
...
-(void)delButtonClick:(UIButton *)btn
{
    [YGAlertView showAlertWithTitle:@"确认删除订单？" buttonTitlesArray:@[@"取消",@"确定"] buttonColorsArray:@[colorWithBlack,colorWithMainColor] handler:^(NSInteger buttonIndex) {
        ...
        }else
        {
            ...
            NSString * url = @"LawOrderDelete";
            if([self.pushView isEqualToString:@"isVIP"])
                url = @"LawVIPOrderDelete";
