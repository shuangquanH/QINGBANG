//
//  SecondhandReplacementISelloutViewController.m
//  QingYouProject
//
...
@interface SecondhandReplacementISelloutViewController ()<YGSegmentViewDelegate,UIScrollViewDelegate>
{
...
@implementation SecondhandReplacementISelloutViewController
...
- (void)configAttribute
{
    ...
    _segmentView = [[YGSegmentView alloc]initWithFrame:CGRectMake(0, 0, YGScreenWidth, 40) titlesArray:@[@"全部",@"待发货",@"待收货",@"已完成"] lineColor:colorWithMainColor delegate:self];
...
- (void)configUI
{
    ...
    _controllersArray = [[NSMutableArray alloc]initWithArray:@[@"SecondhandReplacementISelloutAllOrderViewController",@"SecondhandReplacementISelloutWaitToDelivergoodsOrderViewController",@"SecondhandReplacementISelloutWaitToGoodsReceiptOrderViewController",@"SecondhandReplacementISelloutCompleteOrderViewController"]];
