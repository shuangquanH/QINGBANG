//
//  SecondhandReplacementIBoughtAllOrderViewController.m
//  QingYouProject
//
...
#import "SecondhandReplacementIBoughtAllOrderViewController.h"
...
@interface SecondhandReplacementIBoughtAllOrderViewController ()<UITableViewDelegate,UITableViewDataSource,SecondhandReplacementIBoughtTableViewCellDelegate>
{
...
@implementation SecondhandReplacementIBoughtAllOrderViewController
...
{
    SecondhandReplacementIBoughtModel *model = _dataArray[indexPath.row];
...
- (void)secondhandReplacementIBoughtTableViewCellPayButton:(UIButton *)paybtn withRow:(NSInteger)row
{
    ...
    switch (status) {
        case 1:
        {
            ...
            vc.payType = [NSString stringWithFormat:@"%@",model.buyWay];
            vc.orderNumberString = model.orderNum;
