//
//  SecondhandReplacementIBoughtWaitToPayOrderViewController.m
//  QingYouProject
//
...
#import "SecondhandReplacementIBoughtWaitToPayOrderViewController.h"
...
@interface SecondhandReplacementIBoughtWaitToPayOrderViewController ()<UITableViewDelegate,UITableViewDataSource,SecondhandReplacementIBoughtTableViewCellDelegate>
{
...
@implementation SecondhandReplacementIBoughtWaitToPayOrderViewController
...
-(void)secondhandReplacementIBoughtTableViewCellPayButton:(UIButton *)paybtn withRow:(NSInteger)row
{
        ...
        vc.payType = [NSString stringWithFormat:@"%@",((SecondhandReplacementIBoughtModel*)_dataArray[row]).buyWay];
