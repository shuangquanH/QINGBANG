//
//  SecondhandReplacementSubstitutionViewController.m
//  QingYouProject
//
...
@interface SecondhandReplacementSubstitutionViewController ()<YGSegmentViewDelegate,UIScrollViewDelegate>
{
...
@implementation SecondhandReplacementSubstitutionViewController
...
- (void)configAttribute
{
    ...
    _segmentView = [[YGSegmentView alloc]initWithFrame:CGRectMake(0, 0, YGScreenWidth, 40) titlesArray:@[@"待支付",@"待发货",@"待收货",@"已完成"] lineColor:colorWithMainColor delegate:self];
...
- (void)configUI
{
    ...
    _controllersArray = [[NSMutableArray alloc]initWithArray:@[@"SecondhandReplacementSubstitutionWaitToPayViewController",@"SecondhandReplacementSubstitutionWaitToDelivergoodsViewController",@"SecondhandReplacementSubstitutionWaitToGoodsReceiptViewController",@"SecondhandReplacementSubstitutionCompleteViewController"]];
