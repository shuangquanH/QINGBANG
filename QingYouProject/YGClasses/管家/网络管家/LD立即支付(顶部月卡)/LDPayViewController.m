...
@interface LDPayViewController ()<LDPayItemViewDelegate>
/** 背景ScrollowView  */
...
- (void)sendRequest{
    ...
    [YGNetService YGPOST:@"NetVIPView" parameters:dict showLoadingView:YES scrollView:nil success:^(id responseObject) {
...
- (void)sureButtonClick:(UIButton *)sureButton{
    ...
    if(self.selectPayWay.length >0)
    {
        ...
        [YGNetService YGPOST:@"NetPayOrder" parameters:self.parameters showLoadingView:NO scrollView:nil success:^(id responseObject) {
...
//                    NSLog(@"success");
    ...
    {
        [YGNetService YGPOST:@"NetOfflineOrder" parameters:self.parameters showLoadingView:NO scrollView:nil success:^(id responseObject) {
