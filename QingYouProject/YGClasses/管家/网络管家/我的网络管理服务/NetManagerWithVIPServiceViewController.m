//
//  NetManagerWithVIPServiceViewController.m
//  QingYouProject
//
...
@interface NetManagerWithVIPServiceViewController ()<YGSegmentViewDelegate,UIScrollViewDelegate>
{
...
@implementation NetManagerWithVIPServiceViewController
...
- (void)configAttribute
{
    ...
    [_netButton setTitle:@"网络管理服务" forState:UIControlStateNormal];
...
- (void)configUI
{
    ...
    _controllersArray = [[NSMutableArray alloc]initWithArray:@[@"WaitToNetManagerViewController",@"DealingNetManagerViewController",@"DealedNetManagerViewController"]];
...
- (void)configUIVIP
{
    ...
    _VIPcontrollersArray = [[NSMutableArray alloc]initWithArray:@[@"WaitToNetManagerViewController",@"DealingNetManagerViewController",@"DealedNetManagerViewController"]];
