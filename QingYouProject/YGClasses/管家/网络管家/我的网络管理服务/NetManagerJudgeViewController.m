//
//  NetManagerJudgeViewController.m
//  QingYouProject
//
...
@interface NetManagerJudgeViewController ()<UITextViewDelegate>

@end

@implementation NetManagerJudgeViewController
...
-(void)rightBarButtonClick:(UIButton *)btn
{
    ...
    //意见反馈
    [YGNetService YGPOST:@"NetOrderComment" parameters:@{@"userID":YGSingletonMarco.user.userId,@"context":myTextView.text,@"serviceID":self.serviceID,@"orderID":self.orderID} showLoadingView:YES scrollView:nil success:^(id responseObject) {
