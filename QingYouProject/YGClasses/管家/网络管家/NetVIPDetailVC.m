...
#import "NetVIPDetailVC.h"
#import "NSString+LDAttributedString.h"//富文本属性
#import <WebKit/WebKit.h>
#import "LDNetManagerApplyVC.h"

@interface NetVIPDetailVC ()<SDCycleScrollViewDelegate>
/** 顶部文字label  */
...
- (void)sendRequest{
    ...
    [YGNetService YGPOST:@"NetIndexDetail" parameters:@{@"type":@"2"} showLoadingView:YES scrollView:nil success:^(id responseObject) {
