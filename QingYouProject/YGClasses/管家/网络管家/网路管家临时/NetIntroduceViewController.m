...
@interface NetIntroduceViewController ()<WKUIDelegate,WKNavigationDelegate,UIScrollViewDelegate>

@end

@implementation NetIntroduceViewController
{
    WKWebView       *_webView;
...
- (void)loadData
{
    [YGNetService YGPOST:REQUEST_NetServiceInfo parameters:@{@"serviceID":self.serviceID}  showLoadingView:NO scrollView:nil success:^(id responseObject) {
