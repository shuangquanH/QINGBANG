...
#import "WKSettingPasswordSetValidateController.h"
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(!YGSingletonMarco.user.userId.length)
    {
        ...
        if (indexPath.row == 1) {
            WKSettingAboutusViewController *vc = [[WKSettingAboutusViewController alloc]init];
    ...
    {
        if (indexPath.row == 1) {
            WKSettingPasswordSetValidateController *vc = [[WKSettingPasswordSetValidateController alloc]init];
            [self.navigationController pushViewController:vc animated:YES];
            return;
        }
        if(indexPath.row == 2)
        ...
        if (indexPath.row == 5) {
            WKSettingEvaluateViewController *vc = [[WKSettingEvaluateViewController alloc]init];
            [self.navigationController pushViewController:vc animated:YES];
            return;
        }
        if (indexPath.row == 6) {
