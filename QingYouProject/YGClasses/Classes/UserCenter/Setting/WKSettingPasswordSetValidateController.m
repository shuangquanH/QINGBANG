...
#import "WKSettingPasswordModifilyViewController.h"

@interface WKSettingPasswordSetValidateController ()
{
...
@implementation WKSettingPasswordSetValidateController
...
-(void)nextClick:(UIButton *)button
{
    ...
    [YGNetService YGPOST:REQUEST_checkSMS parameters:@{@"phone":YGSingletonMarco.user.phone,@"type":@"1",@"code":self.verifyTextField.text} showLoadingView:NO scrollView:nil success:^(id responseObject) {
        ...
        WKSettingPasswordModifilyViewController *vc = [[WKSettingPasswordModifilyViewController alloc]init];
