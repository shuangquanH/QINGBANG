...
- (void)huashanxing {
    UIFont *font = [UIFont boldSystemFontOfSize:25.0];//设置
...
//    CGContextSetFillColorWithColor(context, aColor.CGColor);//填充颜色
    ...
    CGContextAddArc(context, 160, 180, 50, -3*M_PI_4, -M_PI_4, 0);
    CGContextClosePath(context);
    CGContextDrawPath(context, kCGPathFillStroke); //绘制路径
    
    //画椭圆
    CGContextAddEllipseInRect(context, CGRectMake(260, 180, 20, 8)); //椭圆
