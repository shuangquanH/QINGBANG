//
//  RushPurchaseOrderListViewController.m
//  QingYouProject
//
...
@interface RushPurchaseOrderListViewController ()<UIScrollViewDelegate>
{
...
@implementation RushPurchaseOrderListViewController
...
- (void)configAttribute
{
    ...
    _segmentView = [[YGSegmentView alloc]initWithFrame:CGRectMake(0, 0, YGScreenWidth, 40) titlesArray:@[@"全部",@"待付款",@"待发货",@"已发货",@"售后"] lineColor:colorWithMainColor delegate:self];
...
- (void)configUI
{
    ...
    _controllersArray = [[NSMutableArray alloc]initWithArray:@[@"AllRushPurchaseOrderListViewController",@"RushPurchaseOrderListWaitToPayViewController",@"RushPurchaseOrderListWaitToGoodsViewController",@"RushPurchaseOrderListDispatchEdGoodsViewController",@"RushPurchaseOrderListAfterSaleViewController"]];
