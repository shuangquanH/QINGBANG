...
const NSTimeInterval kAnimationDuration = 0.6;
...
+ (void)showOpacityAnimatedWithView:(UIView *)view {
    ...
    opacityAnimation.duration = kAnimationDuration * 0.5f;
...
+ (void)showCurveAnimatedWithView:(UIView *)view withOptions:(UIViewAnimationOptions)option {
    view.alpha = 0.0;
    [UIView animateWithDuration:kAnimationDuration delay:0 options:option animations:^{
        view.alpha = 1.0;
    } completion:nil];
}
